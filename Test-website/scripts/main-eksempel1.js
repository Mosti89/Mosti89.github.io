...
let myVariable = document.querySelector("h1"); //Deklarer en variabel med navnet myVariable og tilegner den verdien [object HTMLHeadingElement].
myVariable.textContent = "Hello world!"; //Legger til tekst som et attributt eller hva webleseren skal vise. 
//let myVariable; //Deklarer en variabel med navnet myVariable
//myVariable = "Bob"; //Tilegner variabelen en stringverdi
//let myVariable = "Bob"; //Kan deklarere variabelen og tilegne verdi i samme linje.*/
...
if (iceCream === "chocolate") { //Tester på om iceCream har stirngen "chocolate" i seg
